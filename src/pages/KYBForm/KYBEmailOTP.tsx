...
export default function KYBEmailOTP({ register, errors, email, onVerified, onBack }: Props) {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold mb-6 text-center">Vérification de l'email professionnel</h2>
