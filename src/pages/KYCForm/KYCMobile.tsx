...
export default function KYCMobile({ onContinueOnDevice }: Props) {
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-400">
                  Vérifiez votre boîte de réception pour continuer la vérification
                </p>
              </div>
            </div>
            <Button
          ...
          <div className="space-y-6">
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-400">
                  Vérifiez vos messages pour continuer la vérification
                </p>
              </div>
            </div>
            <Button
