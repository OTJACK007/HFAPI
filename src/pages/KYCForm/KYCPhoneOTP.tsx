...
export default function KYCPhoneOTP({ register, errors, phone, onVerified, onBack }: Props) {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold mb-6 text-center">Vérification du téléphone</h2>
