...
export default function KYCLiveness({ onComplete }: Props) {
          ...
          <div className="space-y-6">
            <div className="flex flex-col items-center gap-3">
              ...
              <p className="text-sm text-gray-400 text-center">
                Cette étape nous permet de vérifier que vous êtes bien une personne réelle
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <ul className="text-sm text-gray-400 space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>Placez votre visage au centre du cadre</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-4 h-4 rounded-full bg-primary/20 flex items-center justify-center mt-0.5">
