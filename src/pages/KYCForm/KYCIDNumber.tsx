...
export default function KYCIDNumber({ register, control, errors, documentType, onNext, onBack }: Props) {
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-2xl font-bold mb-6 text-center">Numéro du document</h2>
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-2 bg-primary/10 p-3 rounded-lg">
          ...
          <p className="text-sm text-white">
            Veuillez saisir le numéro de votre document d'identité
          </p>
        </div>
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-gray-400">
            Ce numéro se trouve sur votre document comme illustré ci-dessous
          </p>
        </div>
