...
export const lightKYCTheme: KYCThemeConfig = {
  theme: 'light',
  colors: {
    primary: '#ff3366',
    buttonColor: '#ff3366',
...
export function mergeWithDefaultKYCTheme(customTheme: Partial<KYCThemeConfig>): KYCThemeConfig {
  return {
    theme: customTheme.theme || defaultKYCTheme.theme,
    colors: {
      ...defaultKYCTheme.colors,
      ...(customTheme.colors || {})
    },
    borderRadius: {
      ...defaultKYCTheme.borderRadius,
