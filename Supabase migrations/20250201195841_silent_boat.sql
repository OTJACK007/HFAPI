...
INSERT INTO public.individual_customers (
  ...
  (
    'f7c8d9e0-1a2b-3c4d-5e6f-123456789abc', -- ID: 2
    'Jane',
    'Smith',
    'jane@example.com',
    '+9876543210',
  ...
  (
    'a1b2c3d4-5e6f-4a5b-8c9d-123456789012', -- ID: 3 (fixed UUID)
    'Bob',
    'Wilson',
    'bob@example.com',
    '+1122334455',
...
INSERT INTO public.business_customers (
  ...
  (
    'b1c2d3e4-5f67-8901-2345-123456789012', -- ID: 1 (fixed UUID)
    'Acme Corp',
    'contact@acme.com',
    '+9998887777',
    'REG123456',
  ...
  (
    'c2d3e4f5-6789-0123-4567-234567890123', -- ID: 2 (fixed UUID)
    'Beta Ltd',
    'info@beta.com',
    '+8887776666',
    'REG654321',
  ...
  (
    'd3e4f5g6-7890-1234-5678-345678901234', -- ID: 3 (fixed UUID)
    'Gamma Inc',
    'hello@gamma.com',
    '+7776665555',
    'REG111222',
    ...
    'LLC',
    'CA',
    'a1b2c3d4-5e6f-4a5b-8c9d-123456789012', -- Bob Wilson
    'rejected',
    '2024-01-23',
    'high',
    FALSE,
...
INSERT INTO public.individual_customer_enterprises (
  ...
  ('a1b2c3d4-5e6f-4a5b-8c9d-123456789012', (SELECT id FROM enterprises ORDER BY created_at ASC LIMIT 1)),
  ('a1b2c3d4-5e6f-4a5b-8c9d-123456789012', (SELECT id FROM enterprises ORDER BY created_at ASC OFFSET 2 LIMIT 1));
...
INSERT INTO public.business_customer_enterprises (
  ...
  ('b1c2d3e4-5f67-8901-2345-123456789012', (SELECT id FROM enterprises ORDER BY created_at ASC OFFSET 1 LIMIT 1)),
  ('b1c2d3e4-5f67-8901-2345-123456789012', (SELECT id FROM enterprises ORDER BY created_at ASC OFFSET 2 LIMIT 1)),
  
  -- Beta Ltd (ID: 2) associated with enterprise 1
  ('c2d3e4f5-6789-0123-4567-234567890123', (SELECT id FROM enterprises ORDER BY created_at ASC LIMIT 1)),
  
  -- Gamma Inc (ID: 3) associated with enterprises 1 and 2
  ('d3e4f5g6-7890-1234-5678-345678901234', (SELECT id FROM enterprises ORDER BY created_at ASC LIMIT 1)),
  ('d3e4f5g6-7890-1234-5678-345678901234', (SELECT id FROM enterprises ORDER BY created_at ASC OFFSET 1 LIMIT 1));